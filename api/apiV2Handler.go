...
func (a *APIv2Handler) initRouter(g *gin.RouterGroup) {
	...
	chiselGroup := g.Group("/chisel")
	{
		chiselGroup.GET("", a.getChiselConfigs)
		chiselGroup.POST("", a.createChiselConfig)
		chiselGroup.GET("/:id", a.getChiselConfig)
		chiselGroup.PUT("/:id", a.updateChiselConfig)
		chiselGroup.DELETE("/:id", a.deleteChiselConfig)
